...
const PRODUCT_TYPES: { value: ProductType; labelEn: string; labelKu: string }[] = [
  { value: 'kitchen_cabinet', labelEn: 'Kitchen Cabinet', labelKu: 'کەوانتەر ' },
  { value: 'bedroom_cabinet', labelEn: 'Bedroom Cabinet', labelKu: ' ژووری نووستن' },
  { value: 'tv_console', labelEn: 'TV Console', labelKu: 'کۆنسۆلی تەلەڤزیۆن' },
  { value: 'shoe_cabinet', labelEn: 'Shoe Cabinet', labelKu: 'جێ پێڵاو' },
  { value: 'understairs_cabinet', labelEn: 'Understairs Cabinet', labelKu: 'کابینەتی ژێر قادرمە' },
  { value: 'custom_console', labelEn: 'Custom Console', labelKu: 'کۆنسۆلی تایبەتمەند' },
];
const BEDROOM_FIELDS = [
  { key: 'upper_cabinet_door_color', enLabel: 'Upper Cabinet Door Color', kuLabel: ' ڕەنگی دەرگای  سەرەوە'  },
  { key: 'lower_cabinet_door_color', enLabel: 'Lower Cabinet Door Color', kuLabel: 'ڕەنگی دەرگای  خوارەوە' },
  { key: 'cabinet_body_color', enLabel: 'Cabinet Body Color', kuLabel: 'ڕەنگی جەستەی کابینەت' },
  { key: 'naxsh', enLabel: 'Naxsh', kuLabel: 'نەخش' },
  { key: 'crown', enLabel: 'Crown', kuLabel: 'تاج' },
  { key: 'handle_type', enLabel: 'Handle Type', kuLabel: 'جۆری دەسک' },
  { key: 'glass_color', enLabel: 'Glass Color', kuLabel: 'ڕەنگی شووشە' },
  { key: 'baza', enLabel: 'Baza', kuLabel: 'بازە' },
  { key: 'liner_led', enLabel: 'Liner LED', kuLabel: 'لید LED' },
];
...
const KITCHEN_FIELDS = [
  ...
  { key: 'cabinet_top', enLabel: 'Cabinet Top', kuLabel: ' سەقفی کەوانتەر' },
  { key: 'stove', enLabel: 'Stove', kuLabel: 'تەباخ' },
  { key: 'countertop', enLabel: 'Countertop (Stone)', kuLabel: 'سەری کەوانتەر (بەرد)' },
  { key: 'liner_led', enLabel: 'Liner LED', kuLabel: 'لید (لینیەر) LED' },
  { key: 'suction_device', enLabel: 'Suction Device', kuLabel: 'موڕەشەح ' },
  { key: 'microwave', enLabel: 'Microwave', kuLabel: 'مایکرۆویڤ' },
  { key: 'mujameda', enLabel: 'Mujameda', kuLabel: 'بەفرگر(مجمدە)' },
  { key: 'handle_type', enLabel: 'Handle Type', kuLabel: 'جۆری دەسک' },
  { key: 'oven', enLabel: 'Oven', kuLabel: 'فڕن' },
  { key: 'fridge', enLabel: 'Fridge', kuLabel: 'سەلاجە' },
  { key: 'washer', enLabel: 'Washer', kuLabel: 'غسالە(ئامێری چل شۆردن) ' },
  { key: 'baza', enLabel: 'Baza', kuLabel: 'بازە' },
  { key: 'glass_color', enLabel: 'Glass Color', kuLabel: 'ڕەنگی شووشە' },
];
